---
name: Melanotan II
otherNames: [MT-II, MT2, "melanotan 2", "the Barbie drug"]
chemicalClass: Synthetic analogue of α-melanocyte-stimulating hormone (α-MSH)
tier: 3
band: serious-risk
...
ratings:
  dependence:
    score: 1
    note: "No tolerance or withdrawal, though people do continue using it to maintain the effect."
    refs: [barbie]
  acuteToxicity:
    score: 3
    note: "Nausea, vomiting, flushing and prolonged erections are common and reach medical attention."
    refs: [barbie, eruptive]
  documentedHarm:
    score: 4
    note: "A consistent international case-report literature of new and changing melanocytic lesions."
    refs: [eruptive, atypical, dermoscopic, dysplastic, oralmelanoma]
  longTerm:
    score: 4
    note: "It stimulates the cell type melanoma arises from, and melanoma is not a reversible outcome."
    refs: [oralmelanoma, dermoscopic, barbie]
  evidenceQuality:
    score: 1
    note: "No modern trials of this compound in this use. Everything known is from case reports."
    refs: [barbie, eruptive]
  productIntegrity:
    score: 5
    note: "An unregulated peptide vial mixed and injected at home, from vendors with no obligations."
    refs: [peptidepurity]
sources:
  - id: eruptive
    citation: "Cardones AR, Grichnik JM. alpha-Melanocyte-stimulating hormone-induced eruptive nevi. Archives of Dermatology."
    pmid: "19380666"
    kind: case-report
    year: 2009
  - id: atypical
    citation: "Atypical melanocytic naevi following melanotan injection. Irish Medical Journal."
    pmid: "23914578"
    kind: case-report
    year: 2013
  - id: dermoscopic
    citation: "Dermoscopic changes in melanocytic nevi during use of melanotan II. Der Hautarzt."
    pmid: "23052015"
    kind: case-report
    year: 2012
  - id: dysplastic
    citation: "Eruptive dysplastic nevi following melanotan use. Actas Dermo-Sifiliográficas."
    pmid: "22425244"
    kind: case-report
    year: 2012
  - id: oralmelanoma
    citation: "Melanotan II nasal spray: a possible risk factor for oral mucosal malignant melanoma? International Journal of Oral and Maxillofacial Surgery."
    pmid: "40210573"
    kind: case-report
    year: 2025
  - id: barbie
    citation: "The risks of tanning with the Barbie drug. Nederlands Tijdschrift voor Geneeskunde."
    pmid: "35736369"
    kind: case-report
    year: 2022
  - id: peptidepurity
