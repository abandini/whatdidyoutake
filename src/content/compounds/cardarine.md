---
name: Cardarine
otherNames: [GW-501516, GW1516, GSK-516, Endurobol]
chemicalClass: PPARδ (peroxisome proliferator-activated receptor delta) agonist
tier: 1
...
ratings:
  dependence:
    score: 1
    note: "No tolerance, no withdrawal, no compulsive use. Stopping is uneventful."
    refs: [dopingreview]
  acuteToxicity:
    score: 1
    note: "No meaningful acute toxicity. A single excessive amount is not the danger here."
    refs: [dopingreview]
  documentedHarm:
    score: 2
    note: "Little documented human harm yet — which reflects short exposure and no follow-up, not safety."
    refs: [dopingreview]
  longTerm:
    score: 5
    note: "Tumours across multiple organ systems in long-duration animal studies ended its development."
    refs: [dopingreview, pparhistory]
  evidenceQuality:
    score: 2
    note: "Short human trials for lipids only. No long-term human data exists and now never will."
    refs: [pparhistory, dopingreview]
  productIntegrity:
    score: 4
    note: "A discontinued research chemical, sold by vendors with no testing obligation to anyone."
    refs: [sarmjama]
sources:
  - id: dopingreview
    citation: "Metabolic modulators of the exercise response: doping control analysis of an agonist of the peroxisome proliferator-activated receptor δ (GW501516) and AICAR. Journal of Physiology and Pharmacology."
    pmid: "25179079"
    kind: reference
    year: 2014
  - id: pparhistory
    citation: "Evolution of peroxisome proliferator-activated receptor agonists. Annals of Pharmacotherapy."
    pmid: "17519293"
    kind: reference
    year: 2007
  - id: immuneescape
    citation: "GW501516 facilitated tumor immune escape by inhibiting phagocytosis. European Journal of Pharmacology."
    pmid: "39993702"
    kind: in-vitro
    year: 2025
  - id: bladder
    citation: "GW501516-Mediated Targeting of Tetraspanin 15 Regulates ADAM10-Dependent N-Cadherin Cleavage in Invasive Bladder Cancer Cells. Cells."
    pmid: "38667323"
    kind: in-vitro
    year: 2024
  - id: sarmjama
...
**In animals:** this is where the programme ended. Long-duration carcinogenicity studies — the standard multi-year rodent studies every drug candidate must pass before it can go near a long-term human population — produced tumours across multiple organ systems. Development stopped.{{pparhistory}}
...
There is also ongoing laboratory work on how PPARδ activation behaves around tumours — including recent studies on immune escape{{immuneescape}} and on invasive bladder cancer cell lines.{{bladder}} That is cell-culture work, not evidence of harm in a person, and we flag it as suggestive rather than conclusive.
