---
name: Kratom
otherNames: [Mitragyna speciosa, ketum, biak-biak, mitragynine]
chemicalClass: Plant leaf containing mitragynine and 7-hydroxymitragynine, partial μ-opioid receptor agonists
tier: 1
band: real-tradeoffs
...
ratings:
  dependence:
    score: 4
    note: "Physical dependence is well documented, with an opioid-type withdrawal on stopping."
    refs: [dependencereview, pharmacology, eightfactor]
  acuteToxicity:
    score: 3
    note: "The leaf alone rarely kills; combined with other depressants it contributes to deaths."
    refs: [deaths, faers]
  documentedHarm:
    score: 4
    note: "Deaths occur but almost always alongside other drugs; liver injury and hospitalisations are documented."
    refs: [deaths, faers]
  longTerm:
    score: 2
    note: "Cholestatic liver injury is reported and usually reverses. No established permanent harm."
    refs: [faers, pharmacology]
  evidenceQuality:
    score: 3
    note: "Good pharmacology and survey data, large observational series, but no controlled therapeutic trials."
    refs: [pharmacology, eightfactor]
  productIntegrity:
    score: 4
    note: "Alkaloid content varies enormously between products, and 7-OH spiking is now common."
    refs: [market, sevenoh]
sources:
  - id: pharmacology
    citation: "An update on the clinical pharmacology of kratom: uses, abuse potential, and future considerations. Expert Review of Clinical Pharmacology."
    pmid: "38217374"
    kind: systematic-review
    year: 2024
  - id: dependencereview
    citation: "Kratom Dependence and Treatment Options: A Comprehensive Review of the Literature. Current Drug Targets."
    pmid: "32682371"
    kind: systematic-review
    year: 2020
  - id: eightfactor
    citation: "Kratom Abuse Potential 2021: An Updated Eight Factor Analysis. Frontiers in Pharmacology."
    pmid: "35197848"
    kind: systematic-review
    year: 2021
  - id: deaths
    citation: "Characteristics of deaths associated with kratom use. Journal of Psychopharmacology."
    pmid: "31429622"
    kind: observational
    year: 2019
  - id: faers
    citation: "An evaluation of adverse drug reactions and outcomes attributed to kratom in the US FDA Adverse Event Reporting System, January 2004 through September 2021. Clinical and Translational Science."
    pmid: "36861661"
    kind: observational
    year: 2023
  - id: sevenoh
    citation: "From kratom to 7-hydroxymitragynine: evolution of a natural remedy into a public-health threat. Pharmaceutical Biology."
    pmid: "41275505"
    kind: systematic-review
    year: 2025
  - id: market
    citation: "Evaluation of the unregulated online kratom market in two east-central European countries: test purchase and analysis of potential toxicological consequences. Harm Reduction Journal."
    pmid: "41382258"
    kind: analytical
    year: 2025
queries:
...
If you want to stop, [stopping kratom](/stopping/kratom) covers what to expect and how to find help. Kratom withdrawal is unpleasant but — unlike phenibut — it is not usually medically dangerous, which changes the options considerably.
