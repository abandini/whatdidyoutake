---
name: Tianeptine
otherNames: [Stablon, Coaxil, Tianaa, Zaza, Neptune's Fix, Pegasus, "tianeptine sodium"]
chemicalClass: Full μ-opioid receptor agonist; licensed as an atypical antidepressant outside the US
tier: 1
...
ratings:
  dependence:
    score: 5
    note: "Full opioid agonism produces fast tolerance, compulsive use and a severe opioid withdrawal."
    refs: [sysrev, mmwr, neonatal2016]
  acuteToxicity:
    score: 4
    note: "Overdose causes respiratory depression reversible with naloxone; seizures are reported."
    refs: [naloxone, mmwr, fda]
  documentedHarm:
    score: 5
    note: "Deaths, seizures, intensive-care admissions and a steeply rising poison-centre signal."
    refs: [mmwr, fda, sysrev]
  longTerm:
    score: 2
    note: "The lasting damage is the addiction rather than demonstrated organ injury."
    refs: [sysrev]
  evidenceQuality:
    score: 3
    note: "Decades of prescribing data at therapeutic amounts, plus a solid recent review of the misuse."
    refs: [sysrev, mmwr]
  productIntegrity:
    score: 5
    note: "Sold as a supplement it is not; products have been recalled for containing entirely other drugs."
    refs: [fda, mmwr]
sources:
  - id: mmwr
    citation: "Characteristics of Tianeptine Exposures Reported to the National Poison Data System — United States, 2000–2017. MMWR Morbidity and Mortality Weekly Report."
    pmid: "30070980"
    kind: poison-centre
    year: 2018
  - id: sysrev
    citation: "Tianeptine misuse and addiction: A systematic review of withdrawal, toxicity, and clinical management. Drug and Alcohol Dependence."
    pmid: "42177839"
    kind: systematic-review
    year: 2026
  - id: naloxone
    citation: "Amitriptyline and tianeptine poisoning treated by naloxone. Human & Experimental Toxicology."
    pmid: "20498036"
    kind: case-report
    year: 2010
  - id: neonatal2016
    citation: "Neonatal Abstinence Syndrome Following Tianeptine Dependence During Pregnancy. Pediatrics."
    pmid: "26659818"
    kind: case-report
    year: 2016
  - id: neonatal2024
    citation: "Neonatal Opioid Withdrawal Syndrome Following Prenatal Use of Supplements Containing Tianeptine. Pediatrics."
    pmid: "38213293"
    kind: case-report
    year: 2024
  - id: fda
    citation: "US Food and Drug Administration. Tianeptine Products Linked to Serious Harm, Overdoses, Death."
    url: "https://www.fda.gov/consumers/consumer-updates/tianeptine-products-linked-serious-harm-overdoses-death"
    kind: regulatory
    year: 2024
queries:
  - what is tianeptine
  ...
  - neptunes fix seizures
stoppingPage: /stopping/tianeptine
...
**On pregnancy:** there are published cases of neonatal withdrawal syndrome in babies born to mothers who used tianeptine, including cases where the mother had been using a product sold as a supplement. Reports appear across more than a decade{{neonatal2016}}{{neonatal2024}}, which suggests this is not a one-off.
...
**Do not simply stop if you have been using it heavily and often.** Tianeptine withdrawal is not usually life-threatening in the way alcohol or [phenibut](/stopping/phenibut) withdrawal can be, but it is severe, and it is one of the harder opioid withdrawals people describe. There is medical treatment for it and there is no reason to do it unmedicated.

[Stopping tianeptine](/stopping/tianeptine) covers what to expect and how to find treatment without insurance.
