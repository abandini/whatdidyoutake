---
name: Ostarine
otherNames: [MK-2866, enobosarm, GTx-024, S-22]
...
ratings:
  dependence:
    score: 1
    note: "No tolerance, no withdrawal, no compulsive-use pattern. Stopping is uneventful."
    refs: [sarmreview]
  acuteToxicity:
    score: 2
    note: "No meaningful single-exposure danger. The problems here develop over weeks, not hours."
    refs: [sarmreview, phase2]
  documentedHarm:
    score: 3
    note: "A consistent set of published liver-injury cases in otherwise healthy young men."
    refs: [dili, sarmdili]
  longTerm:
    score: 3
    note: "Suppression usually recovers, but nobody has followed anyone for years to confirm it."
    refs: [phase2, power, sarmreview]
  evidenceQuality:
    score: 3
    note: "Genuine randomised trials up to phase 3 — far more than any other SARM has."
    refs: [phase2, power, sarmreview]
  productIntegrity:
    score: 5
    note: "Analysis of products sold online found roughly half did not contain the labelled SARM."
    refs: [jama]
sources:
  - id: phase2
    citation: "Dobs AS et al. Effects of enobosarm on muscle wasting and physical function in patients with cancer: a double-blind, randomised controlled phase 2 trial. The Lancet Oncology."
    pmid: "23499390"
    kind: randomised-trial
    year: 2013
  - id: power
    citation: "Study Design and Rationale for the Phase 3 Clinical Development Program of Enobosarm, a Selective Androgen Receptor Modulator, for the Prevention and Treatment of Muscle Wasting in Cancer Patients (POWER Trials). Current Oncology Reports."
    pmid: "27138015"
    kind: reference
    year: 2016
  - id: sarmreview
    ...
    year: 2025
  - id: dili
    citation: "Drug-Induced Liver Injury Secondary to Enobosarm: A Selective Androgen Receptor Modulator. Journal of Medical Cases."
    pmid: "35655632"
    kind: case-report
    year: 2022
  - id: sarmdili
...
queries:
  ...
  - is ostarine safe
  - ostarine liver damage
  - do you need a pct after ostarine
...
Ostarine is not a central nervous system depressant and does not carry the fatal-combination risk that dominates the [phenibut](/compounds/phenibut) and [tianeptine](/compounds/tianeptine) pages.
...
[Cardarine](/compounds/cardarine) is very commonly sold and stacked alongside ostarine. It is not a SARM, it does not work the same way, and its risk profile is entirely different and considerably worse on the dimension that matters. Do not let their being sold together suggest they are the same class of decision.
