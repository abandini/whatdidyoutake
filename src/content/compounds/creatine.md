---
name: Creatine
otherNames: [creatine monohydrate, Creapure]
chemicalClass: Naturally occurring amino acid derivative; sold as a dietary supplement
tier: 3
band: low-concern
...
ratings:
  dependence:
    score: 1
    note: "No tolerance, no withdrawal, and no compulsive-use pattern anywhere in the literature."
    refs: [issn]
  acuteToxicity:
    score: 1
    note: "Excess is simply excreted. Taking too much causes stomach upset, not injury."
    refs: [issn, factfiction]
  documentedHarm:
    score: 1
    note: "No credible reports of serious harm in healthy people across decades of widespread use."
    refs: [requiem, factfiction]
  longTerm:
    score: 1
    note: "Long-duration studies find no organ damage, including in the kidneys people worry about."
    refs: [renal, requiem]
  evidenceQuality:
    score: 5
    note: "Hundreds of controlled human trials, meta-analyses, and a formal scientific position stand."
    refs: [issn, strength]
  productIntegrity:
    score: 2
    note: "Plain monohydrate is usually exactly that, but supplements face no pre-market testing anywhere."
    refs: [issn]
sources:
  - id: issn
    citation: "Kreider RB et al. International Society of Sports Nutrition position stand: safety and efficacy of creatine supplementation in exercise, sport, and medicine. Journal of the International Society of Sports Nutrition."
    pmid: "28615996"
    kind: systematic-review
    year: 2017
  - id: strength
    citation: "Effects of creatine supplementation on muscle strength gains — a meta-analysis and systematic review. PeerJ."
    pmid: "41328071"
    kind: systematic-review
    year: 2025
  - id: renal
    citation: "Poortmans JR, Francaux M. Long-term oral creatine supplementation does not impair renal function in healthy athletes. Medicine and Science in Sports and Exercise."
    pmid: "10449011"
    kind: controlled-trial
    year: 1999
  - id: requiem
    citation: "Is It Time for a Requiem for Creatine Supplementation-Induced Kidney Failure? A Narrative Review. Nutrients."
    pmid: "36986197"
    kind: systematic-review
    year: 2023
  - id: factfiction
    citation: "Poortmans JR, Francaux M. Adverse effects of creatine supplementation: fact or fiction? Sports Medicine."
    pmid: "10999421"
    kind: systematic-review
    year: 2000
queries:
  ...
  - creatine raised my creatinine levels
