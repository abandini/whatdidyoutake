---
name: Phenibut
otherNames: [β-phenyl-GABA, fenibut, Anvifen, Noofen, Fenibut, phenybut]
chemicalClass: GABA-B receptor agonist, structurally related to baclofen
tier: 1
band: evidence-says-dont
...
ratings:
  dependence:
    score: 5
    note: "Tolerance within days to weeks, and abrupt cessation after regular use is medically dangerous."
    refs: [currentpsych, sysrev, litreview]
  acuteToxicity:
    score: 4
    note: "Overdose causes deep sedation and reaches emergency departments routinely; far worse combined."
    refs: [toxidrome, sedhyp, buts]
  documentedHarm:
    score: 4
    note: "A large and growing set of published hospitalisations for intoxication and withdrawal."
    refs: [sysrev, litreview, wmj, agitation, dependence]
  longTerm:
    score: 2
    note: "No established permanent organ damage, though intoxication itself causes injury through falls and aspiration."
    refs: [currentpsych, buts]
  evidenceQuality:
    score: 2
    note: "Efficacy rests on Soviet-era work below modern standards; the harm data is case reports."
    refs: [cnsdrugrev, buts]
  productIntegrity:
    score: 4
    note: "Sold as an unregulated bulk powder that the buyer measures at home, with no independent testing."
    refs: [currentpsych, phenibutan]
sources:
  - id: cnsdrugrev
    citation: "Lapin I. Phenibut (beta-phenyl-GABA): a tranquilizer and nootropic drug. CNS Drug Reviews."
    pmid: "11830761"
    kind: reference
    year: 2001
  - id: currentpsych
    citation: "Phenibut (β-Phenyl-γ-Aminobutyric Acid): an Easily Obtainable \"Dietary Supplement\" With Propensities for Physical Dependence and Addiction. Current Psychiatry Reports."
    pmid: "30852710"
    kind: systematic-review
    year: 2019
  - id: litreview
    citation: "Acute phenibut withdrawal: A comprehensive literature review and illustrative case report. Bosnian Journal of Basic Medical Sciences."
    pmid: "30501608"
    kind: case-report
    year: 2019
  - id: sysrev
    citation: "A Systematic Review of Phenibut Withdrawals. Cureus."
    pmid: "39376891"
    kind: systematic-review
    year: 2024
  - id: buts
    citation: "Phenibut: A drug with one too many \"buts\". Basic & Clinical Pharmacology & Toxicology."
    pmid: "39197876"
    kind: systematic-review
    year: 2024
  - id: dependence
    citation: "Phenibut dependence. BMJ Case Reports."
    pmid: "23391959"
    kind: case-report
    year: 2013
  - id: wmj
    citation: "Chronic Phenibut Use: Symptoms, Severe Withdrawal, and Recovery. WMJ."
    pmid: "35442585"
    kind: case-report
    year: 2022
  - id: agitation
    citation: "Psychomotor Agitation Non-responsive to Treatment: A Case Report of Phenibut Withdrawal Syndrome. Frontiers in Psychiatry."
    pmid: "34262493"
    kind: case-report
    year: 2021
  - id: toxidrome
    citation: "Toxidrome of an Easily Obtainable Nootropic: A Case Report of Phenibut Intoxication and Withdrawal Delirium. Journal of Clinical Psychopharmacology."
    pmid: "37930202"
    kind: case-report
    year: 2023
  - id: sedhyp
    citation: "Sedative-Hypnotic Agents That Impact Gamma-Aminobutyric Acid Receptors: Focus on Flunitrazepam, Gamma-Hydroxybutyric Acid, Phenibut, and Selank. Journal of Clinical Pharmacology."
    pmid: "34396551"
    kind: reference
    year: 2021
  - id: phenibutan
    citation: "Phenibutan — an Illegal Food Supplement With Psychotropic Effects and Health Risks. Deutsches Ärzteblatt International."
    pmid: "38377332"
    kind: systematic-review
    year: 2024
queries:
  ...
  - phenibut anxiety
stoppingPage: /stopping/phenibut
...
If you are reading the escalation pattern above and recognising it, that is the thing to act on, and now is better than later — this gets harder the longer it runs, not easier. **Do not stop abruptly on your own.** [Stopping phenibut](/stopping/phenibut) explains why, and what to do instead.
...
[Stopping phenibut](/stopping/phenibut) covers what the published literature says clinicians do, how to find someone to supervise it if you do not have a doctor, and what to expect. It gives no amounts and no schedule, and that is deliberate — coming off this drug without supervision is precisely the thing that goes wrong.

If you are unwell right now, [start here](/emergency). Poison Control will talk to you, free, at any hour, and they are not law enforcement.
