---
name: Gray-market GLP-1s
otherNames: ["research-grade semaglutide", "compounded semaglutide", "research peptide tirzepatide", retatrutide]
chemicalClass: GLP-1 receptor agonists obtained outside the regulated supply chain
tier: 3
band: serious-risk
...
ratings:
  dependence:
    score: 1
    note: "No dependence, no withdrawal, no compulsive use. This is not that kind of risk."
    refs: [marketsurvey]
  acuteToxicity:
    score: 4
    note: "Preparation and measuring errors have caused severe vomiting, hypoglycaemia and hospital admission."
    refs: [poisoncontrol]
  documentedHarm:
    score: 3
    note: "A documented poison-centre series of overdoses from self-prepared product."
    refs: [poisoncontrol, marketsurvey]
  longTerm:
    score: 2
    note: "The molecules themselves are well characterised; the long-term risk is not the main problem here."
    refs: [brazil]
  evidenceQuality:
    score: 4
    note: "The drugs are extremely well studied. What is in an unregulated vial is not the drug that was studied."
    refs: [brazil, marketsurvey]
  productIntegrity:
    score: 5
    note: "Unverified identity and strength, plus the buyer preparing and measuring it themselves."
    refs: [marketsurvey, poisoncontrol, peptidepurity]
sources:
  - id: poisoncontrol
    citation: "Administration errors of compounded semaglutide reported to a poison control center — case series. Journal of the American Pharmacists Association."
    pmid: "37392810"
    kind: case-series
    year: 2023
  - id: marketsurvey
    citation: "Multifactor Quality and Safety Analysis of Semaglutide Products Sold by Online Sellers Without a Prescription: Market Surveillance, Content Analysis, and Product Purchase Evaluation Study. Journal of Medical Internet Research."
    pmid: "39509151"
    kind: analytical
    year: 2024
  - id: brazil
    citation: "GLP-1 Receptor Agonists in Brazil: Landscape of Consumption, Safety and Regulation. Diabetes, Obesity & Metabolism."
    pmid: "41796096"
    kind: observational
    year: 2026
  - id: peptidepurity
    ...
    year: 2020
queries:
  - is research grade semaglutide safe
  - compounded semaglutide overdose
  - gray market glp-1
  - buying semaglutide online without prescription
